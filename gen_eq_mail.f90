...
do i=1,nstmax
   read(13,*,end=9,err=9)stalist(i),netlist(i)
enddo
9 close(13) 
...
do ieq=1,neqmax
   ...
   write(label,'(i4.4,"_",i2.2,"_",i2.2,"_",i2.2,"_",i2.2,"_",i2.2,"_",i3.3)')year,month,day,hour,mmin,sec,msec
   open(12,file=mail)
   ...
   write(12,'(".ALTERNATE MEDIA :  Electronic (FTP)")')
   write(12,'(".LABEL",1x,1a)')trim(label)
   write(12,'(".QUALITY B")')
   write(12,'(".END")')
   write(12,'("")')
   do ista=1,n_sta
